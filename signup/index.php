            ...
            <div class="container">
                ...
                <div class="login-content">
                    <form action="signup.php" method="post">
                        <h2 class="title">Registrierung ShS</h2>
                        <div class="input-div one">
                            ...
                            <div class="div">
                                <h5>Vorname</h5>
                                <input name="firstname" type="text" class="input" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="input-div pass">
                            ...
                            <div class="div">
                                <h5>Nachname</h5>
                                <input name="lastname" type="text" class="input" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="input-div pass">
                            <div class="i">
                            ...
                            <div class="div">
                                <h5>Benutzername</h5>
                                <input id="txtUsername" name="username" type="text" class="input" autocomplete="off" required oninput="check()">
                            </div>
                        </div>
                        <div class="input-div pass">
                            <div class="i">
                            ...
                            <div class="div">
                                <h5>Emailaddresse</h5>
                                <input name="mail" type="text" class="input" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="input-div pass">
                            <div class="i">
                            ...
                            <div class="div">
                                <h5>Passwort</h5>
                                <input name="password" type="password" class="input" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="input-div pass">
                            <div class="i">
                            ...
                            <div class="div">
                                ...
                                <input type="password" name="passwdconfirm" class="input" autocomplete="off" required>
                            </div>
                        ...
                        <input id="submit" type="submit" class="btn" value="Registriere dich">
                    </form>
                </div>
            </div>
            </div>
