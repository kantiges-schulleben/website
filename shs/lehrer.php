<?php
    ...
    */
    ...
    $t = time();
    //teacher
    SQL("UPDATE handschlag SET terminlink='$tlink" . ";" . strval($t) . "' WHERE name LIKE '$teacher'");

    //student/s

    for ($sLink = 0; $sLink < count($students); $sLink++) {
        SQL("UPDATE handschlag SET terminlink='$sLinks[$sLink]" . ";" . strval($t) . "' WHERE name LIKE '$students[$sLink]'");
    }
