...
<body>
    ...
    <section class="home">
        <div class="showcase">
            <h2>Schüler*innen helfen Schülern</h2>
            <img src="../assets/Main_shs/shs.png" alt="" />
            <div class="info">
                <h3>Werde Teil von Schüler*innen helfen Schülern</h3>
                <p>
                Schüler*innen helfen Schülern ist ein Projekt, welches den Schülern*innen ermöglicht<br>
                 sich gegenseitig unter die Arme zu greifen und voneinander zu profitieren.<br>
                  Schüler*innen treten in die Rolle der Nachhilfelehrer*innen und unterstützen ihre Mitschüler*innen.<br> 
                Indem du an diesem Projekt teilnimmst, gibst du Nachhilfeunterricht oder erhältst diesen. <br>
                Die Stunden können zum aktuellen Zeitpunkt auch wieder präsent stattfinden.<br>
                 Du möchtest helfen oder du brauchst Hilfe dann kannst du dich bei über diese Webseite beim Projekt ShS anmelden.<br>
                </p>
            </div>
        </div>
    </section>
        ...
        <section class="features">
            ...
            <div class="cards">
                ...
                <div class="card">
                    ...
                    <h4>Registrierung</h4>
                    <p>Wenn du an dem Projekt „Schüler*innen helfen Schülern“ teilnehmen möchtest. Egal ob als Nachhilfeschüler*in oder Nachhilfelehrer*in. Dann registriere dich <b><a style="color: black" href="../signup/">hier</a></b>.</p>
                </div>
                <div class="card">
